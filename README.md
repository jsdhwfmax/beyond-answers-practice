...
本仓库整理自正式版 **1.0.3**，包含完整应用源码、测试、数据库迁移、锁文件及运行素材。参赛材料见 [九页计划书 PDF](docs/project/答案之外-项目计划书-参赛版.pdf) 和 [图文正文](docs/project/答案之外-项目计划书-提交正文.md)。计划书中的模拟对话为明确标注的演示，不是真实同学的私人对话记录。
